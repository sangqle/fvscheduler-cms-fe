...
import { buildGoogleAuthUrl, GOOGLE_CALLBACK_PATH, GOOGLE_OAUTH_STATE_KEY } from '@/lib/api/auth';

/** Chữ G nhiều màu của Google: brand asset, giữ đúng màu (ngoại lệ hex đã ghi trong DS). */
